                                    ...
                                    <div class="card-body">
                                        <form method="post" name="signup" onsubmit="return checkpass();">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="email" name="email" type="email" placeholder="" required  value="<?php if(isset($_GET['inviteuser'])) { echo base64_decode($_GET['inviteuser']);} ?>" <?php if(isset($_GET['inviteuser'])){echo 'readonly';}else{ echo '';} ?>/>
